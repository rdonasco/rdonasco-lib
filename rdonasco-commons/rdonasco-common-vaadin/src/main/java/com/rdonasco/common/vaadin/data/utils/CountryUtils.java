...
public final class CountryUtils
{
    ...
    private static final String[] ISO_3166 = new String[]
    {
        "AFGHANISTAN", "AF",
    ...
    public static final Object ISO_3166_PROPERTY_NAME = "name";
    public static final Object ISO_3166_PROPERTY_FLAG = "flag";
    private static final IndexedContainer iso3166Container = new IndexedContainer();
    
    static 
    {
        iso3166Container.addContainerProperty(ISO_3166_PROPERTY_NAME,
                String.class, null);
        iso3166Container.addContainerProperty(ISO_3166_PROPERTY_FLAG,
                Resource.class, null);
        for (int i = 0; i < ISO_3166.length; i++)
        {
            String name = ISO_3166[i++];
            String id = ISO_3166[i];
            Item item = iso3166Container.addItem(id);
            item.getItemProperty(ISO_3166_PROPERTY_NAME).setValue(name);
            item.getItemProperty(ISO_3166_PROPERTY_FLAG).setValue(
