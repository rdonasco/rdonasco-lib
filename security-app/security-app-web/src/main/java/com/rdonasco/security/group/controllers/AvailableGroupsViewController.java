 ...
 */
public class AvailableGroupsViewController extends ListEditorViewPanelController<RoleItemVO>
{

	private static final long serialVersionUID = 1L;
	private static final String CONSTANT_TITLE = "name";
	...
	{
		return I18NResource.localize("Group");
	}

	@Override
	public String getListName()
	{
		return I18NResource.localize("Groups");
	}
}
