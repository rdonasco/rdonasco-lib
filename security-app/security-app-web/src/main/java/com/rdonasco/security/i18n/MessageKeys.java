...
public final class MessageKeys
{
	...
	public static final String DO_YOU_REALLY_WANT_TO_DELETE_THIS = "Do you really want to delete this?";
	...
	public static final String CAPABILITY_DELETED = "Capability deleted";

	public static final String UNABLE_TO_ADD_NEW_CAPABILITY = "Unable to add new capability";
	// user message keys

	public static final String USER_PROFILE_DELETED = "User profile deleted";

	public static final String UNABLE_TO_ADD_NEW_USER = "Unable to add new user";
	...
	public static final String UNABLE_TO_ADD_NEW_APPLICATION = "Unable to add new application";
