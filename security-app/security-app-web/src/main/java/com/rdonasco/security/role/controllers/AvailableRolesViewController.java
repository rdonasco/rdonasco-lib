 ...
 */
public class AvailableRolesViewController extends ListEditorViewPanelController<RoleItemVO>
{
	...
	{
		return I18NResource.localize("Role");
	}

	@Override
	public String getListName()
	{
		return I18NResource.localize("Roles");
	}
}
