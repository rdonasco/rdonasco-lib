...
public class WidgetInitalizeException extends WidgetException
{
    ...
    public WidgetInitalizeException(Throwable cause)
    {
        super(cause);
    }

    public WidgetInitalizeException(String message, Throwable cause)
    {
        super(message, cause);
    }

    public WidgetInitalizeException(String message)
    {
        super(message);
    }
}
