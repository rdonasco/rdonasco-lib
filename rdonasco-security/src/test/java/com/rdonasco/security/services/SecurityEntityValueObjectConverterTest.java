...
public class SecurityEntityValueObjectConverterTest
{
	...
	public void testToUserProfileNoCapability() throws Exception
	{
		...
		UserSecurityProfileVO userSecurityProfileVO = createTestDataUserSecurityProfileVOwithoutCapability();
	...
	public void testToUserProfileWithCapability() throws Exception
	{
		...
		UserCapabilityVO userCapability = createTestDataUserCapabilityVO(capability);
		UserSecurityProfileVO userProfileVO = createTestDataUserSecurityProfileVOwithUserCapability(userCapability);
	...
	public void testToCapabilityVO() throws Exception
	{
		...
		Capability testCapability = createTestDataCapability();
		List<Action> actions = createTestDataActions();
	...
	public void testToCapability() throws Exception
	{
		...
		CapabilityVO testCapabilityVO = createTestDataCapabilityVO();
